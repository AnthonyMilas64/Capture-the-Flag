...
public class ServerGUIController implements Initializable {
    ...
    @FXML
    public TextField  portTextField, sendTextField, txtShop;
    @FXML
    private Button connectButton, btnRdy, btnSendMsg, btnPlayAgain;
    @FXML
...
//    private boolean cClicked,sClicked;
    ...
    class FxSocketListener implements SocketListener {
        ...
        public void onMessage(String line) {
            ...
            else if(line.substring(0,3).equals("rdy")){ //if the opponent is ready, checks to see if the game can start
                player2Rdy = true;
                checkStartGame();
    ...
    //the player is ready to play again and resets the game
    @FXML
    ...
    private boolean player1Rdy = false; //player 1 is not ready to start
    private boolean player2Rdy = false; //player 2 is not ready to start
    private void checkStartGame(){ //if both players are ready to start, the game starts
    ...
    private String gemTarget = "sapphire"; //the type of gem the opponent needs to capture
    private String opponentTarget = "ruby"; //the type of gem the player needs to capture
    private int xStartR = 1; //the x coordinate of the room the player starts in
    private int yStartR = 4; //the y coordinate of the room the player starts in
